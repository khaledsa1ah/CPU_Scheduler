...
//            String color = scanner.next();
            ...
            Color color = Color.decode(colorString); // Convert string to Color
...
//        list.add(p4);
        ...
        Vector<Color> processesColor = processesColor(processes);
        ...
        if (algorithmName.equals("AG")) {
            ...
            PrioritySchedulingAlgorithm p = new PrioritySchedulingAlgorithm(processes);
            ...
            SRTFAlgorithm s = new SRTFAlgorithm(processes);
            ...
            SJFAlgorithm sjf = new SJFAlgorithm(processes, contextSwitchingTime);
            sjf.simulateSJF();
